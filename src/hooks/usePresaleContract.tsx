...
const usePresaleContract = (network, userAddress, presaleContractAddress, referralCode) => {
    ...
    const fetchPresaleInfo = useCallback(async () => {
        try {
            ...
            // console.log('[usePresaleContract] Fetching presale data for:', presaleContractAddress);
            ...
            // console.log('[usePresaleContract] Contract initialized at:', presaleContractAddress);

            // Fetch data from contract
            // console.log('[usePresaleContract] Fetching contract data...');
            const [
                totalRaised,
                participantCount,
                finalized,
            ...
            // console.log('[usePresaleContract] Successfully fetched contract data');
